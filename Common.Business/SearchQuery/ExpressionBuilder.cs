        ...
        private static Expression BuildCondition(Expression parameter, string property, OperatorComparer comparer, object value)
        {
            ...
            switch (typeName)
            {
                ...
                case "Int64":
                    ...
                    {
                        throw new BusinessException("El valor para el filtro no es válido. Se esperaba Numero Entero");
                    }
                ...
                case "DateTime":
                    ...
                    {
                        throw new BusinessException("El valor para el filtro no es válido. Se esperaba Fecha en formato 'dd/mm/aaaa'");
                    }
                    break;
                default:
                    try
                    ...
                    {
                        throw new BusinessException($"El valor para el filtro no es válido. Se esperaba {childProperty.PropertyType.Name}");
                    }
